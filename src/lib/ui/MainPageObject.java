...
public class MainPageObject {
    ...
    public void assertPresenceTheElementTextByTitle(String locator, String error_message, long timeoutInSeconds, String assertMassage, String expected) {
        WebElement element = waitForElementPresent(locator, error_message, 5);
...
//    Дописать метод для IOS                 .moveTo(end_y, x ) со свайпом в другую сторону.
    ...
    public void swipeUpToFindElement(String locator, String error_message, int max_swipes) {
        ...
        while (driver.findElements(by).size() == 0) {
            if (already_swipe > max_swipes) {
                waitForElementPresent(locator, "Cannot find element by swipingUP. \n" + error_message, 0);
                return;
            }
            swipUpQuick();
            ++already_swipe;
